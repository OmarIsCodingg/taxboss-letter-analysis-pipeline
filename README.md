...
OCR (Claude Sonnet).. extracts text from an uploaded letter image Classification (Claude Haiku).. categorizes the letter into one of ~18 types with structured metadata Explanation (Claude Sonnet).. generates a plain-language, actionable explanation for the user.
